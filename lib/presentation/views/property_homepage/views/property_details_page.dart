...
class PropertyDetailsPage extends StatelessWidget {
  ...
  /// We always use the static demo property
  final PropertyModel property = demoProperty;
  ...
  @override
  Widget build(BuildContext context) {
    // If you want to completely ignore offline logic during testing,
    // you can just set enabled: false below.
    return Obx(() {
      return Scaffold(
        body: SingleChildScrollView(
          child: Skeletonizer(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AgentWidget(
                        agentId: property.agent?.id ?? 2,
                        agentImage: property.agent?.photo ??
                            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbrmM6dgWVMTOFm_JQ4_K0xtfD8hOOm1EYrw&s",
                        agentName: property.agent?.name ?? 'Agent',
                        agentRole: property.agent?.phone ?? "+96380817760",
                      ),
